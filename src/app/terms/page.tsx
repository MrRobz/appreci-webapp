      ...
      <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-8 lg:py-12">
        <div className="relative w-full bg-white px-6 py-12 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pb-28 lg:pt-16">
          <div className="prose prose-slate mx-auto lg:prose-lg">
            ...
            <p>Last updated: 2023-07-10</p>
            <p>
              1. <b>Introduction</b>
            </p>
            <p>
              Welcome to <b>Appreci bot</b> (“Company”, “we”, “our”, “us”)!
            </p>
            <p>
              These Terms of Service (“Terms”, “Terms of Service”) govern your
              use of our website located at <b>apprecibot.com</b> (together or
              individually “Service”) operated by <b>Appreci bot</b>.
            </p>
            <p>
            ...
            <p>
              ...
              <b>support@apprecibot.com</b> so we can try to find a solution.
            ...
            <p>
              ...
              emailing at support@apprecibot.com.
            </p>
            <p>
              3. <b>Purchases</b>
            </p>
            ...
            <p>
              ...
              cancel it or Appreci bot cancels it. You may cancel your
              Subscription renewal either through your online account management
              page or by contacting support@apprecibot.com customer support
              team.
            </p>
            <p>
              A valid payment method is required to process the payment for your
              subscription. You shall provide Appreci bot with accurate and
              ...
              information, you automatically authorize Appreci bot to charge all
              Subscription fees incurred through your account to any such
              payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason, Appreci bot
            ...
            <p>
              Appreci bot may, at its sole discretion, offer a Subscription with
            ...
            <p>
              ...
              Trial, you will not be charged by Appreci bot until Free Trial has
            ...
            <p>
              At any time and without notice, Appreci bot reserves the right to
            ...
            <p>
              Appreci bot, in its sole discretion and at any time, may modify
              Subscription fees for the Subscriptions. Any Subscription fee
              change will become effective at the end of the then-current
              Billing Cycle.
            </p>
            <p>
              Appreci bot will provide you with a reasonable prior notice of any
            ...
            <p>
              Appreci bot has the right but not the obligation to monitor and
              edit all Content provided by users.
            </p>
            <p>
              In addition, Content found on or through this Service are the
              property of Appreci bot or used with permission. You may not
            ...
            <p>
              ...
              exclusive property of Appreci bot and its licensors. Service is
              ...
              product or service without the prior written consent of Appreci
              bot.
            </p>
            <p>
            ...
            <p>
              ...
              via email to support@apprecibot.com, with the subject line:
            ...
            <p>
              You may provide us either directly at support@apprecibot.com or
            ...
            <p>
              ...
              that are not owned or controlled by Appreci bot.
            </p>
            <p>
              Appreci bot has no control over, and assumes no responsibility for
            ...
            <p>
              ...
              support by email: <b>support@apprecibot.com</b>.
            </p>
            <p>
              These{' '}
              <a href="https://policymaker.io/terms-and-conditions/">
              ...
              were created for <b>apprecibot.com</b> by{' '}
              <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-07-10.
            </p>
          </div>
        </div>
      </div>
