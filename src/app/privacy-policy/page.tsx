        ...
        <div className="relative w-full bg-white px-6 py-12 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pb-28 lg:pt-16">
          <div className="prose prose-slate mx-auto lg:prose-lg">
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to Appreci bot, the
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Appreci bot.
                </p>
              </li>
              <li>
                <p>
            ...
            <ul>
              <li>
                <p>By email: office@apprecibot.com</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:{' '}
                  <a
                    href="https://apprecibot.com/privacy-policy"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://apprecibot.com/privacy-policy
                  </a>
                </p>
              </li>
            </ul>
